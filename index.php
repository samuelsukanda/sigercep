...
<head>
    ...
    <!-- Icon Shortcut -->
    <link rel="shortcut icon" href="../sigercep/app/dist/img/rs.png">
    <!-- Bootstrap -->
    ...
    <style>
        ...
        @font-face {
            ...
            src: url('../sigercep/app/dist/font/SegoeUIBold.woff');
        }


        @font-face {
            font-family: 'SegoeUI';
            src: url('../sigercep/app/dist/font/SegoeUI.woff');
        }
            ...
            <div class="col-md-6 justify-content-center d-flex mt-5">
                <form action="conf/autentikasi.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="username" class="form-control" id="username" maxlength="10" style='text-transform:lowercase'>
                    </div>
                    ...
                    <button type="submit" class="btn btn-signup btn-block">Log In</button>
                </form>
            </div>

            <div class="bg col-md-6">
                <img src="../sigercep/app/dist/img/hmr.png" alt="background" height="570px">
            </div>
        </div>
    </div>
</body>

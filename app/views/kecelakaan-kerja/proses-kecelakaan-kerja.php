                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $sql = "SELECT COUNT(*) as count FROM data_kecelakaan_kerja WHERE nama='$nama' AND tanggal='$tanggal'";
                                $result = $koneksi->query($sql);
                                $row = $result->fetch_assoc();
                                $count = $row['count'];

                                if ($count == 0) {
                                    $sql = "INSERT INTO data_kecelakaan_kerja (nama, unit, no_hp, jam, tanggal, jenis_kecelakaan, lokasi_kecelakaan, saksi, kegiatan, riwayat, penyebab, bahan, cedera, pengobatan, pengobatan2, pelaksana, tanda_tangan, waktu_input) 
                                VALUES ('$nama', '$unit', '$no_hp', '$jam', '$tanggal', '$jenis_kecelakaan', '$lokasi_kecelakaan', '$saksi', '$kegiatan', '$riwayat', '$penyebab', '$bahan', '$cedera', '$pengobatan', '$pengobatan2', '$pelaksana', '$nama_file_tanda_tangan', '$waktu_input')";

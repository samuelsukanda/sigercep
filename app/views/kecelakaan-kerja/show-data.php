                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Data Kecelakaan Kerja</h3>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        ...
                                        if ($id) {
                                            $sql = "SELECT * FROM data_kecelakaan_kerja WHERE id = '$id'";
                                            ...
                                            if ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    <th>9</th>
                                                    <th>Kegiatan Yang Dilakukan Saat Kejadian :</th>
                                                    <td>" . $row['kegiatan'] . "</td>
                                                </tr>
                                                <tr>
                                                    <th>10</th>
                                                ...
                                                <tr>
                                                    <th>12</th>
                                                    <th>Nama/Jenis Bahan/Zat yang Menyebabkan (Jika Ada) :</th>
                                                    <td>" . $row['bahan'] . "</td>
                                                </tr>
                                                <tr>
                                                    <th>13</th>
                                                ...
                                                <tr>
                                                    <th>14</th>
                                                    <th>Tindakan Pengobatan Pertama yang Dilakukan :</th>
                                                    <td>" . $row['pengobatan'] . "</td>
                                                </tr>
                                                <tr>
                                                    <th>15</th>
                                                    <th>Tindakan Pengobatan Selanjutnya :</th>
                                                    <td>" . $row['pengobatan2'] . "</td>
                                                </tr>
                                                <tr>
                                                    <th>16</th>
                                                    <th>Pelaksana/Pemberi Pengobatan :</th>
                                                    <td>" . $row['pelaksana'] . "</td>
                                                </tr>
                                            </table>";
                                                echo "<div class='signature'>
                                            <span class='alamat'>Subang, " . $tanggal . "</span>
                                            <br>
                                            Tanda Tangan Pelapor: 
                                            <br>
                                            <img src='uploads/" . $row['tanda_tangan'] . "' width='170px' height='60px'/>
                                            <br>
                                            " . $row['nama'] . "
                                            </div>";
                                            } else {

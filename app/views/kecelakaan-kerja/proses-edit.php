                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $lokasi_kecelakaan = mysqli_real_escape_string($koneksi, $_POST['lokasi_kecelakaan']);
                                $saksi = mysqli_real_escape_string($koneksi, $_POST['saksi']);
                                $kegiatan = mysqli_real_escape_string($koneksi, $_POST['kegiatan']);
                                $riwayat = mysqli_real_escape_string($koneksi, $_POST['riwayat']);
                                $penyebab = mysqli_real_escape_string($koneksi, $_POST['penyebab']);
                                $bahan = mysqli_real_escape_string($koneksi, $_POST['bahan']);
                                $cedera = mysqli_real_escape_string($koneksi, $_POST['cedera']);
                                $pengobatan = mysqli_real_escape_string($koneksi, $_POST['pengobatan']);
                                $pengobatan2 = mysqli_real_escape_string($koneksi, $_POST['pengobatan2']);
                                ...
                                $query = "UPDATE data_kecelakaan_kerja SET 
                            nama = '$nama',
                            unit = '$unit',
                            no_hp = '$no_hp',
                            jam = '$jam',
                            ...
                            ?>
                                    <script>
                                        window.location.href = 'data-kecelakaan-kerja.php';
                                    </script>
                            <?php
                                    exit();
                                } else {

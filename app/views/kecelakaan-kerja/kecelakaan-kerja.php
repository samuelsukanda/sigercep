                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Kecelakaan Kerja</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Kecelakaan Kerja</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-kecelakaan-kerja.php" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="jenis_kecelakaan" name="jenis_kecelakaan" placeholder="Masukkan Jenis Kecelakaan" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="lokasi_kecelakaan">Lokasi Kecelakaan:</label>
                                            <input type="text" class="form-control" id="lokasi_kecelakaan" name="lokasi_kecelakaan" placeholder="Masukkan Lokasi Kecelakaan" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="saksi">Saksi (Jika Ada):</label>
                                            <input type="text" class="form-control" id="saksi" name="saksi" placeholder="Masukkan Saksi">
                                        </div>

                                        <div class="form-group">
                                            <label for="kegiatan">Kegiatan Yang Dilakukan Saat Kejadian:</label>
                                            <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder="Masukkan kegiatan">
                                        </div>

                                        <div class="form-group">
                                            <label for="riwayat">Riwayat Kecelakaan:</label>
                                            <input type="text" class="form-control" id="riwayat" name="riwayat" placeholder="Masukkan Riwayat Kecelakaan">
                                        </div>

                                        <div class="form-group">
                                            <label for="penyebab">Penyebab Kecelakaan:</label>
                                            <input type="text" class="form-control" id="penyebab" name="penyebab" placeholder="Masukkan Penyebab Kecelakaan">
                                        </div>

                                        <div class="form-group">
                                            <label for="bahan">Nama/Jenis Bahan/Zat Yang Menyebabkan (Jika Ada):</label>
                                            <input type="text" class="form-control" id="bahan" name="bahan" placeholder="Masukkan Jenis Bahan/Zat">
                                        </div>

                                        <div class="form-group">
                                            <label for="cedera">Bagian Tubuh Yang Cedera:</label>
                                            <input type="text" class="form-control" id="cedera" name="cedera" placeholder="Masukkan Bagian Tubuh Yang Cedera">
                                        </div>

                                        <div class="form-group">
                                            <label for="pengobatan">Tindakan Pengobatan Pertama Yang Dilakukan:</label>
                                            <input type="text" class="form-control" id="pengobatan" name="pengobatan" placeholder="Masukkan Tindakan Pengobatan Pertama">
                                        </div>

                                        <div class="form-group">
                                            <label for="pengobatan2">Tindakan Pengobatan Selanjutnya:</label>
                                            <input type="text" class="form-control" id="pengobatan2" name="pengobatan2" placeholder="Masukkan Tindakan Pengobatan Selanjutnya">
                                        </div>

                                        <div class="form-group">
                                            <label for="pelaksana">Pelaksana/Pemberi Pengobatan:</label>
                                            <input type="text" class="form-control" id="pelaksana" name="pelaksana" placeholder="Masukkan Pelaksana/Pemberi Pengobatan">
                                        </div>

                                        <div class="form-group">
                                            <label for="tanda_tangan">Tanda Tangan Pelapor:</label>
                                            <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-kecelakaan-kerja.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->

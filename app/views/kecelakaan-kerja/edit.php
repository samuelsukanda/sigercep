...
$query = "SELECT * FROM data_kecelakaan_kerja WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Kecelakaan Kerja</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-edit.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="jenis_kecelakaan" name="jenis_kecelakaan" value="<?php echo $data['jenis_kecelakaan']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="lokasi_kecelakaan">Lokasi Kecelakaan:</label>
                                            <input type="text" class="form-control" id="lokasi_kecelakaan" name="lokasi_kecelakaan" value="<?php echo $data['lokasi_kecelakaan']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="saksi">Saksi (Jika Ada):</label>
                                            <input type="text" class="form-control" id="saksi" name="saksi" value="<?php echo $data['saksi']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="kegiatan">Kegiatan Yang Dilakukan Saat Kejadian:</label>
                                            <input type="text" class="form-control" id="kegiatan" name="kegiatan" value="<?php echo $data['kegiatan']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="riwayat">Riwayat Kecelakaan:</label>
                                            <input type="text" class="form-control" id="riwayat" name="riwayat" value="<?php echo $data['riwayat']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="penyebab">Penyebab Kecelakaan:</label>
                                            <input type="text" class="form-control" id="penyebab" name="penyebab" value="<?php echo $data['penyebab']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cedera" name="cedera" value="<?php echo $data['cedera']; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pengobatan2" name="pengobatan2" value="<?php echo $data['pengobatan2']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="pelaksana">Pelaksana/Pemberi Pengobatan:</label>
                                            <input type="text" class="form-control" id="pelaksana" name="pelaksana" value="<?php echo $data['pelaksana']; ?>">
                                        </div>
    ...
    <script src="../../dist/js/validasi-k3rs.js"></script>
</body>

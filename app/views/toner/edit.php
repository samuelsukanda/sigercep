...
$query = "SELECT * FROM data_toner WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Toner</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="toner" name="toner" required>
                                                ...
                                                foreach ($optionsToner as $option) {
                                                    $selected = ($toner == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
    ...
    <script src="../../dist/js/validasi-toner.js"></script>
</body>

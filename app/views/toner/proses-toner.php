                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $toner = mysqli_real_escape_string($koneksi, $_POST['toner']);
                                ...
                                $sql = "INSERT INTO data_toner (nama, unit, toner, jumlah, tanggal, tanda_tangan, waktu_input) 
                                VALUES ('$nama', '$unit', '$toner', '$jumlah', '$tanggal', '$nama_file_tanda_tangan', '$waktu_input')";

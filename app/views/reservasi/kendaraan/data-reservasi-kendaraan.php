            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Data Reservasi Kendaraan</h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM data_reservasi_kendaraan ORDER BY waktu_input DESC LIMIT $start, $limit";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $waktu_input = date('d-m-y H:i', strtotime($row['waktu_input']));
                            ...
                            <td>";
                            if ($row['waktu_tempuh'] > '4 Jam') {
                              echo "<div class='alert alert-danger' role='alert'>";
                            }
                            echo $row['waktu_tempuh'];
                            if ($row['waktu_tempuh'] > '4 Jam') {
                              echo "</div>";
                            }
                            echo "</td>
                          ...
                          $sql_count = "SELECT COUNT(*) as total FROM data_reservasi_kendaraan";
                          $result_count = mysqli_query($koneksi, $sql_count);
                          $row_count = mysqli_fetch_assoc($result_count);
                        } else {
                          echo "<tr><td colspan='13'>Belum ada data yang masuk.</td></tr>";
                        }

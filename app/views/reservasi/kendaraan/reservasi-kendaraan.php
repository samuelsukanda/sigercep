                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Reservasi Kendaraan</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-reservasi-kendaraan.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tempat_tujuan" name="tempat_tujuan" placeholder="Masukan Tempat Tujuan" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="keperluan">Keperluan:</label>
                                            <input type="text" class="form-control" id="keperluan" name="keperluan" placeholder="Masukan Keperluan" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="jenis_kendaraan" name="jenis_kendaraan" required>
                                                <option value="Operational Xpander (Khusus Marketing)">Operational Xpander (Khusus Marketing)</option>
                                                <option value="Operational Avanza">Operational Avanza</option>
                                                <option value="Ambulance Alphard">Ambulance Alphard</option>
                                                <option value="Ambulance Luxio">Ambulance Luxio</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" id="driver" name="jenis_layanan" value="Dengan Driver" required>
                                            <label for="driver">Dengan Driver</label><br>
                                            <input type="radio" id="tanpa-driver" name="jenis_layanan" value="Tanpa Driver" required>

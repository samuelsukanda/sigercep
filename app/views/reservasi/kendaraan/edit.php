...
$query = "SELECT * FROM data_reservasi_kendaraan WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Reservasi Kendaraan</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-edit.php">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tempat_tujuan" name="tempat_tujuan" value="<?php echo $data['tempat_tujuan']; ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" id="jam_berangkat" name="jam_berangkat" value="<?php echo $data['jam_berangkat']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="jam_pulang">Jam Pulang:</label>
                                            <input type="time" class="form-control" id="jam_pulang" name="jam_pulang" value="<?php echo $data['jam_pulang']; ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="jenis_kendaraan" name="jenis_kendaraan" required>
                                                <?php
                                                ...
                                                foreach ($options as $option) {
                                                    $selected = ($jenis_kendaraan == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="jumlah_penumpang" name="jumlah_penumpang" required>
                                                <?php
                                                ...
                                                foreach ($options as $option) {
                                                    $selected = ($jumlah_Penumpang == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="waktu_tempuh" name="waktu_tempuh" required>
                                                <?php
                                                ...
                                                foreach ($options as $option) {
                                                    $selected = ($waktu_tempuh == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="jarak_tempuh" name="jarak_tempuh" required>
                                                <?php
                                                ...
                                                foreach ($options as $option) {
                                                    $selected = ($jarak_tempuh == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="jenis_layanan">Pemakaian Mobil dengan atau tanpa Driver:</label><br>
                                            <input type="radio" id="driver" name="jenis_layanan" value="Dengan Driver" onclick="toggleForm()" required <?php echo ($data['jenis_layanan'] == 'Dengan Driver') ? 'checked' : ''; ?>>
                                            <label for="driver">Dengan Driver</label><br>
                                            <input type="radio" id="tanpa-driver" name="jenis_layanan" value="Tanpa Driver" onclick="toggleForm()" required <?php echo ($data['jenis_layanan'] == 'Tanpa Driver') ? 'checked' : ''; ?>>
                                            <label for="tanpa-driver">Tanpa Driver</label>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-reservasi-kendaraan.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                    </div> <!-- /.card-body -->
                                </form>
                            </div>
    ...
    <script src="../../../dist/js/form-input-time.js"></script>
    <script src="../../../dist/js/validasi-kendaraan.js"></script>
</body>

        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              $tempat_tujuan = mysqli_real_escape_string($koneksi, $_POST['tempat_tujuan']);
              ...
              $waktu_tempuh = mysqli_real_escape_string($koneksi, $_POST['waktu_tempuh']);
              $jarak_tempuh = mysqli_real_escape_string($koneksi, $_POST['jarak_tempuh']);
              ...
              $query = "SELECT * FROM data_reservasi_kendaraan WHERE tanggal='$tanggal' AND jenis_kendaraan='$jenis_kendaraan' AND ('$jam_berangkat' BETWEEN jam_berangkat AND jam_pulang OR '$jam_pulang' BETWEEN jam_berangkat AND jam_pulang)";
              $result = mysqli_query($koneksi, $query);

              if (mysqli_num_rows($result) > 0) {
                echo '<div class="alert alert-danger alert-dismissible">
                <h5><i class="icon fas fa-check"></i> Error!</h5>
                Maaf, waktu reservasi yang anda inputkan sudah ada yang mendaftar.
              </div>';
              } else {
                $query = "INSERT INTO data_reservasi_kendaraan (nama, unit, tempat_tujuan, keperluan, jam_berangkat, jam_pulang, tanggal, jenis_kendaraan, jumlah_penumpang, waktu_tempuh, jarak_tempuh, jenis_layanan, waktu_input)
                    VALUES ('$nama', '$unit', '$tempat_tujuan', '$keperluan', '$jam_berangkat', '$jam_pulang', '$tanggal', '$jenis_kendaraan', '$jumlah_penumpang', '$waktu_tempuh', '$jarak_tempuh', '$jenis_layanan', '$waktu_input')";
                $result = mysqli_query($koneksi, $query);

                if ($result) {
                  echo '<div class="alert alert-success alert-dismissible">
                      <h5><i class="icon fas fa-check"></i> Success!</h5>
                      Terima kasih, data reservasi anda telah berhasil disimpan!
                    </div>';
                } else {
                  echo '<div class="alert alert-danger alert-dismissible">
                  <h5><i class="icon fas fa-check"></i> Error!</h5>
                  Maaf, terjadi kesalahan saat menyimpan data reservasi anda.
                </div>';
                }
              }

            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Data Reservasi Ruangan</h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped">
                      <thead>
                        <tr>
                          ...
                          <?php if (($_SESSION['level'] == 'SUPER ADMIN' && $_SESSION['nama'] == 'IT') ||
                            ($_SESSION['level'] == 'ADMIN' && $_SESSION['nama'] == 'KOMITE MEDIK')
                          ) { ?>
                            <th>Aksi</th>
                          <?php } ?>
                        </tr>
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM data_reservasi_ruangan ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          ...
                          $sql_count = "SELECT COUNT(*) as total FROM data_reservasi_ruangan";

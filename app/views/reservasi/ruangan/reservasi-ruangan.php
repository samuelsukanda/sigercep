                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Reservasi Ruangan</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-reservasi-ruangan.php">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="ruang" name="ruang" required>
                                                ...
                                                <option value="Diklat">Ruang Diklat</option>
                                                <option value="Komite Medik">Ruang Komite Medik</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->

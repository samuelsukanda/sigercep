        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              $query = "SELECT * FROM data_reservasi_ruangan WHERE tanggal = '$tanggal' AND ruang = '$ruang' AND ('$jam_mulai' BETWEEN jam_mulai AND jam_selesai OR '$jam_selesai' BETWEEN jam_mulai AND jam_selesai)";
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                $query = "INSERT INTO data_reservasi_ruangan (nama, unit, jam_mulai, jam_selesai, tanggal, ruang, waktu_input) 
                  VALUES ('$nama', '$unit', '$jam_mulai', '$jam_selesai', '$tanggal', '$ruang', '$waktu_input')";
                $result = mysqli_query($koneksi, $query);

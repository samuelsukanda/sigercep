                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $sql = "SELECT COUNT(*) as count FROM data_peminjaman WHERE nama='$nama' AND tanggal='$tanggal'";
                                $result = $koneksi->query($sql);
                                $row = $result->fetch_assoc();
                                $count = $row['count'];

                                if ($count == 0) {
                                    $sql = "INSERT INTO data_peminjaman (nama, unit, tanggal, barang, tanda_tangan, waktu_input) 
                                VALUES ('$nama', '$unit', '$tanggal', '$barang', '$nama_file_tanda_tangan', '$waktu_input')";

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-peminjaman.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="barang">Alat/Barang yang di pinjam:</label>
                                            <input type="text" class="form-control" id="barang" name="barang" placeholder="Masukkan Alat/Barang" required>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-peminjaman.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $desain = mysqli_real_escape_string($koneksi, $_POST['desain']);
                                ...
                                if ($desain === "Video") {
                                    ...
                                    $detik = mysqli_real_escape_string($koneksi, $_POST['detik']);
                                } else {
                                    $width = mysqli_real_escape_string($koneksi, $_POST['width']);
                                    $height = mysqli_real_escape_string($koneksi, $_POST['height']);
                                    $satuan = mysqli_real_escape_string($koneksi, $_POST['satuan']);
                                }

                                $waktu_input = mysqli_real_escape_string($koneksi, $_POST['waktu_input']);

                                $query = "UPDATE data_desain_grafis SET 
                                nama = '$nama',
                                unit = '$unit',
                                keperluan = '$keperluan',
                                tanggal = '$tanggal',
                            ...
                            ?>
                                    <script>
                                        window.location.href = 'data-desain-grafis.php';
                                    </script>
                            <?php
                                    exit();
                                } else {

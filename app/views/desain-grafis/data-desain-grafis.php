            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Data Desain Grafis</h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM data_desain_grafis ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if ($row['desain'] === "Video") {
                              echo "<td></td>";
                              echo "<td>" . $row['menit'] . " : " . $row['detik'] . "</td>";
                            } else {
                              echo "<td>" . $row['width'] . " X " . $row['height'] . " " . $row['satuan'] . "</td>";
                              echo "<td></td>";
                            }
                          ...
                          $sql_count = "SELECT COUNT(*) as total FROM data_desain_grafis";

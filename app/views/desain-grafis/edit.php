...
$query = "SELECT * FROM data_desain_grafis WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Desain Grafis</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Desain Grafis</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-edit.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="desain">Desain:</label> <br>
                                            <input type="radio" id="foto" name="desain" value="Foto" <?php echo ($data['desain'] == 'Foto') ? 'checked' : ''; ?> required>
                                            <label for="foto">Foto</label> <br>
                                            <input type="radio" id="video" name="desain" value="Video" <?php echo ($data['desain'] == 'Video') ? 'checked' : ''; ?> required>
                                            <label for="video">Video</label> <br>
                                            <input type="radio" id="spanduk" name="desain" value="Spanduk" <?php echo ($data['desain'] == 'Spanduk') ? 'checked' : ''; ?> required>
                                            <label for="spanduk">Spanduk</label> <br>
                                            <input type="radio" id="brosur" name="desain" value="Brosur" <?php echo ($data['desain'] == 'Brosur') ? 'checked' : ''; ?> required>
                                            <label for="brosur">Brosur</label> <br>
                                            <input type="radio" id="banner" name="desain" value="Roll Up Banner" <?php echo ($data['desain'] == 'Roll Up Banner') ? 'checked' : ''; ?> required>
                                            <label for="banner">Roll Up Banner</label>
                                        </div>

                                        <div id="form-ukuran">
                                            <div class="form-group">
                                                <label for="ukuran">Ukuran Desain:</label> <br>
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <span class="judulwidth">Width</span>
                                                        <input type="number" class="form-control" name="width" id="width" value="<?php echo $data['width']; ?>" required>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <span class="judulheight">Height</span>
                                                        <input type="number" class="form-control" name="height" id="height" value="<?php echo $data['height']; ?>" required>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <span class="judulsize">Size</span>
                                                        <select class="form-control select2bs4" name="satuan" id="satuan" required>
                                                            <option value="px" <?php echo ($data['satuan'] == 'px') ? 'selected' : ''; ?>>px</option>
                                                            <option value="cm" <?php echo ($data['satuan'] == 'cm') ? 'selected' : ''; ?>>cm</option>
                                                            <option value="m" <?php echo ($data['satuan'] == 'm') ? 'selected' : ''; ?>>m</option>
                                                            <option value="inch" <?php echo ($data['satuan'] == 'inch') ? 'selected' : ''; ?>>inch</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="form-durasi">
                                            <div class="form-group">
                                                <label for="durasi">Durasi Video:</label> <br>
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <span class="menit">Menit</span>
                                                        <select class="form-control select2bs4" name="menit" id="menit" required>
                                                            <?php
                                                            for ($i = 0; $i <= 60; $i++) {
                                                                echo "<option value='$i' " . (($data['menit'] == $i) ? 'selected' : '') . ">$i</option>";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        ...
                                                        <select class="form-control select2bs4" name="detik" id="detik" required>
                                                            <?php
                                                            for ($i = 0; $i <= 60; $i++) {
                                                                echo "<option value='$i' " . (($data['detik'] == $i) ? 'selected' : '') . ">$i</option>";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-desain-grafis.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->
    ...
    <script src="../../dist/js/validasi-desain.js"></script>
</body>

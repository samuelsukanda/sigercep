                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Desain Grafis</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-desain-grafis.php">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" id="foto" name="desain" value="Foto" required>
                                            <label for="foto">Foto</label> <br>
                                            <input type="radio" id="video" name="desain" value="Video" required>
                                            <label for="video">Video</label> <br>
                                            <input type="radio" id="spanduk" name="desain" value="Spanduk" required>
                                            <label for="spanduk">Spanduk</label> <br>
                                            <input type="radio" id="brosur" name="desain" value="Brosur" required>
                                            <label for="brosur">Brosur</label> <br>
                                            <input type="radio" id="banner" name="desain" value="Roll Up Banner" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        ...
                                                        <input type="number" class="form-control" name="width" id="width" placeholder="Lebar" required>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <span class="judulheight">Height</span>
                                                        <input type="number" class="form-control" name="height" id="height" placeholder="Panjang" required>
                                                    </div>
                                                    <div class="col-sm-2">

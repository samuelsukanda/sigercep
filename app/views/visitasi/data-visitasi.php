            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Data Visitasi</h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM data_visitasi ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>" . $tanggal . "</td>
                            <td>" . $row["kendala"] . "</td>
                            <td><a href='#modal" . $row['id'] . "' data-bs-toggle='modal'><img src='" . 'uploads/' . $row['foto'] . "' width='150px' height='100px'/></a></td>";
                    ...
                    <div class='modal-content'>
                        ...
                        <img src='" . 'uploads/' . $row['foto'] . "' class='img-fluid modal-image' alt='Gambar'>
                        </div>
                    </div>
                    </div>
                </div>";
                          ...
                          $sql_count = "SELECT COUNT(*) as total FROM data_visitasi";

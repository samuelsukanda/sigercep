...
$query = "SELECT * FROM data_visitasi WHERE id=$id";
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Visitasi</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-edit.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="tim" name="tim" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="kendala" name="kendala" rows="3" required><?php echo $data['kendala']; ?></textarea>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-visitasi.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->

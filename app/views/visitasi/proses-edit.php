                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            $tim = mysqli_real_escape_string($koneksi, $_POST['tim']);
                            ...
                            if ($_FILES['foto']['size'] > 0) {
                                ...
                                $query_select_foto = "SELECT foto FROM data_visitasi WHERE id = '$id'";
                            ...
                            $query = "UPDATE data_visitasi SET 
                                    nama = '$nama',
                                    tim = '$tim',
                                    tanggal = '$tanggal',
                                    kendala = '$kendala',
                            ...
                            ?>
                                <script>
                                    window.location.href = 'data-visitasi.php';
                                </script>
                            <?php
                            } else {

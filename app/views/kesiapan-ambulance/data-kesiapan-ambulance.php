                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT * FROM data_kesiapan_ambulance ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        $kondisiMobil = $row['kondisi_mobil'];
                                                        if ($kondisiMobil === 'Other' && !empty($row['kondisi_mobil_input'])) {
                                                            $kondisiMobil = $row['kondisi_mobil_input'];
                                                        }
                                                        ...
                                                        <td>" . $tanggal . "</td>
                                                        <td>" . $row['perawat'] . "</td>
                                                        <td><a class='btn btn-block btn-info' href='show-data.php?id=" . $row['id'] . "'>Show All</a></td>";
                                                    ...
                                                    $sql_count = "SELECT COUNT(*) as total FROM data_kesiapan_ambulance";

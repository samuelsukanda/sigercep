...
$query = "SELECT * FROM data_komplain_makanan WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Komplain Makanan</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-edit.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="waktu_makan" name="waktu_makan" required>
                                                <option selected disabled>Pilih Waktu Makan</option>
                                                <?php
                                                $waktu_makan = $data['waktu_makan'];
                                                $waktu_makanOptions = array(
                                                    "Pagi",
                                                    "Siang",
                                                    "Sore"
                                                );
                                                foreach ($waktu_makanOptions as $option) {
                                                    $selected = ($waktu_makan == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="pendapat">Pendapat Anda Terkait Pelayanan dan Variasi Makan yang Disajikan?</label>
                                            <select class="form-control select2bs4" id="pendapat" name="pendapat" required>
                                                <option selected disabled>Pilih Pendapat</option>
                                                <?php
                                                $pendapat = $data['pendapat'];
                                                $pendapatOptions = array(
                                                    "Kurang Baik",
                                                    "Cukup Baik",
                                                    "Baik"
                                                );
                                                foreach ($pendapatOptions as $option) {
                                                    $selected = ($pendapat == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="saran" name="saran" row="3" required><?php echo $data['saran']; ?></textarea>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-komplain-makanan.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="../../../dist/js/validasi-makanan.js"></script>
</body>

            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Data Komplain Makanan</h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM data_komplain_makanan ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>" . $row['pendapat'] . "</td>
                            <td>" . $row['saran'] . "</td>
                            <td><a href='#modal" . $row['id'] . "' data-bs-toggle='modal'><img src='" . 'uploads/' . $row['foto'] . "' width='80px' height='50px'/></a></td>";
                          ...
                          $sql_count = "SELECT COUNT(*) as total FROM data_komplain_makanan";

        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              $query = "INSERT INTO data_komplain_makanan (nama, unit, tanggal, no_hp, waktu_makan, pendapat, saran, foto, waktu_input) 
              VALUES ('$nama', '$unit', '$tanggal', '$no_hp', '$waktu_makan', '$pendapat', '$saran', '$foto', '$waktu_input')";

            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Data Komplain IPSRS</h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped">
                      <thead>
                        <tr>
                          ...
                          <?php if (($_SESSION['level'] == 'SUPER ADMIN' && $_SESSION['nama'] == 'IT') ||
                            ($_SESSION['level'] == 'ADMIN' && $_SESSION['nama'] == 'IPSRS')
                          ) { ?>
                            <th>Aksi</th>
                          <?php } ?>
                        </tr>
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM data_komplain_ipsrs ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>" . $row["nama"] . "</td>
                            <td>" . $row["unit"] . "</td>
                            <td>" . $row["tujuan_unit"] . "</td>
                            <td>" . $tanggal . "</td>
                            <td>" . $row["kendala"] . "</td>
                            <td><a href='#modal" . $row['id'] . "' data-bs-toggle='modal'><img src='uploads/" . $row['foto'] . "' width='100px' height='80px'/></a></td>
                            <td>";
                            if ($row['status'] == 'On Progress') {
                              echo "<div class='alert alert-warning alert-sm' role='alert'>";
                            } elseif ($row['status'] == 'Pending') {
                              echo "<div class='alert alert-danger alert-sm' role='alert'>";
                            } elseif ($row['status'] == 'Done') {
                              echo "<div class='alert alert-success alert-sm' role='alert'>";
                            }
                            echo $row['status'];
                            if ($row['status'] == 'On Progress' || $row['status'] == 'Pending') {
                              echo "</div>";
                            }
                            echo "</td>
                            ...
                            if (($_SESSION['level'] == 'SUPER ADMIN' && $_SESSION['nama'] == 'IT') ||
                              ...
                              echo "<td>
                                  <a href='edit.php?id=" . $row['id'] . "' class='btn btn-block btn-success'>Edit</a>
                                    ...
                                    <div class='modal-dialog modal-lg'>
                                        <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='modalLabel" . $row['id'] . "'>Foto</h5>
                                                <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                                            </div>
                                            <div class='modal-body d-flex justify-content-center align-items-center'>";

                            if ($foto && file_exists('uploads/' . $foto)) {
                              echo "<img src='uploads/" . $foto . "' class='img-fluid modal-image' alt='Gambar'>";
                            }
                          ...
                          $sql_count = "SELECT COUNT(*) as total FROM data_komplain_ipsrs";
                          $result_count = mysqli_query($koneksi, $sql_count);
                          $row_count = mysqli_fetch_assoc($result_count);
                        } else {
                          echo "<tr><td colspan='9'>Belum ada data yang masuk.</td></tr>";
                        }

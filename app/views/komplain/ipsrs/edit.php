...
$query = "SELECT * FROM data_komplain_ipsrs WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Komplain IPSRS</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
    ...
    <script src="../../../dist/js/validasi-ipsrs.js"></script>
</body>

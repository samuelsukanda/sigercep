          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $sql = "INSERT INTO data_komplain_ipsrs (nama, unit, tujuan_unit, tanggal, kendala, foto, waktu_input)
                  VALUES ('$nama', '$unit', '$tujuan_unit', '$tanggal', '$kendala', '$foto', '$waktu_input')";

                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Form Komplain IPSRS</h3>
                                </div>
                                <!-- /.card-header -->

                                <!-- form start -->
                                <form id="form" method="POST" action="proses-komplain-ipsrs.php" enctype="multipart/form-data" onsubmit="return validateFile()">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="tujuan_unit" name="tujuan_unit" required>
                                                ...
                                                <option value="Atem">Elektromedis (Atem)</option>
                                            </select>
                                        </div>

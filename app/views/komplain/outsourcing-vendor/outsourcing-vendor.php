                        ...
                        <?php if ($menu['komplain']) : ?>
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../ipsrs/komplain-ipsrs.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>IPSRS</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="outsourcing-vendor.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Outsourcing & Vendor</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Komplain Outsourcing & Vendor</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-outsourcing-vendor.php" enctype="multipart/form-data" onsubmit="return validateFile()">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="tujuan_unit">Ditujukan Ke Unit:</label>
                                            <select class="form-control select2bs4" id="tujuan_unit" name="tujuan_unit" required>
                                                <option selected disabled>Pilih Unit</option>
                                                <option value="ISS">ISS</option>
                                                <option value="HMA">HMA</option>
                                                <option value="Laundry">Laundry</option>
                                                <option value="Security ATALIAN">Security ATALIAN</option>
                                                <option value="Parkir Berlian">Parkir Berlian</option>
                                                <option value="Tata Graha (Taman)">Tata Graha (Taman)</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="kendala">Kendala atau Pengaduan di lapangan:</label>
                                            <textarea type="text" class="form-control" id="kendala" name="kendala" row="3" required></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="area">Area komplain yang dilaporkan:</label>
                                            <input type="text" class="form-control" id="area" name="area" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="foto">Foto Komplain/Keluhan di Lapangan:</label>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="foto" name="foto" accept="image/jpeg,image/jpg,image/png">
                                                <label class="custom-file-label" for="customFile" id="foto" name="foto" accept="image/jpeg,image/jpg,image/png">Choose file</label>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-outsourcing-vendor.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->

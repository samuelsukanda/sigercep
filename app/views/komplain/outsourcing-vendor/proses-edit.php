                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            $tujuan_unit = mysqli_real_escape_string($koneksi, $_POST['tujuan_unit']);
                            ...
                            if ($_FILES['foto']['size'] > 0) {
                                ...
                                $query_select_foto = "SELECT foto FROM data_komplain_outsourcing_vendor WHERE id = '$id'";
                            ...
                            $query = "UPDATE data_komplain_outsourcing_vendor SET 
                            nama = '$nama',
                            unit = '$unit',
                            tujuan_unit = '$tujuan_unit',
                            jam = '$jam',
                            tanggal = '$tanggal',
                            kendala = '$kendala',
                            area = '$area',
                            ...
                            ?>
                                <script>
                                    window.location.href = 'data-outsourcing-vendor.php';
                                </script>
                            <?php
                                exit();
                            } else {

            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Data Outsourcing & Vendor</h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM data_komplain_outsourcing_vendor ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if ($foto && file_exists('uploads/' . $foto)) {
                              echo "<a href='#modal" . $row['id'] . "' data-bs-toggle='modal'><img src='uploads/" . $foto . "' width='100px' height='80px'/></a>";
                            }
                          ...
                          $sql_count = "SELECT COUNT(*) as total FROM data_komplain_outsourcing_vendor";

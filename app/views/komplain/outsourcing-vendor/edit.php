...
$query = "SELECT * FROM data_komplain_outsourcing_vendor WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Outsourcing & Vendor</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="tujuan_unit" name="tujuan_unit" required>
                                                <?php
                                                $tujuan_unit = $data['tujuan_unit'];
                                                $tujuanOptions = array(
                                                    "ISS" => "ISS",
                                                    "HMA" => "HMA",
                                                    "Laundry" => "Laundry",
                                                    "Security ATALIAN" => "Security ATALIAN",
                                                    "Parkir Berlian" => "Parkir Berlian",
                                                    "Tata Graha (Taman)" => "Tata Graha (Taman)"
                                                );
                                                foreach ($tujuanOptions as $value => $label) {
                                                    $selected = ($tujuan_unit == $value) ? 'selected' : '';
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="kendala" name="kendala" row="3" required><?php echo $data['kendala']; ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="foto">Foto Komplain/Kerusakan/Kendala di Lapangan:</label>
    ...
    <script src="../../../dist/js/validasi-out.js"></script>
</body>

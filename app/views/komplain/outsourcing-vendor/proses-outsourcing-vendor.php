        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              $query = "INSERT INTO data_komplain_outsourcing_vendor (nama, unit, tujuan_unit, jam, tanggal, kendala, area, foto, waktu_input)
              VALUES ('$nama', '$unit', '$tujuan_unit', '$jam', '$tanggal', '$kendala', '$area', '$foto', '$waktu_input')";

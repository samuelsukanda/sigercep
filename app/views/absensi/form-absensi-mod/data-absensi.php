    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <form method="GET" action="data-absensi-print.php">
                    ...
                    <br>
                    <!-- <label for="no_from">No From:</label>
                    <input type="text" id="no_from" name="no_from">
                    <label for="no_revisi">No Revisi:</label>
                    <input type="text" id="no_revisi" name="no_revisi"> -->
                </form>
                ...
                if (isset($_GET['tanggal'])) {
                    ...
                    $sql = "SELECT * FROM data_absensi_mod $where LIMIT $start, $limit";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        $sql_count = "SELECT COUNT(*) as total FROM data_absensi_mod $where";
                        ...
                        for ($i = 1; $i <= $total_pages; $i++) {
                            if ($i == $page) {
                                echo "<a class='active' href='data-absensi.php?tanggal=$tanggal&page=$i'>$i</a>";
                            } else {
                                echo "<a href='data-absensi.php?tanggal=$tanggal&page=$i'>$i</a>";
                            }
                        }
                        echo "</div>";
                    } else {

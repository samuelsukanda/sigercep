...
<body>
    <div class="container">
        ...
        <div class="row date">
            ...
            <p>Topik : <?php echo isset($_GET['topik']) ? $_GET['topik'] : ''; ?> Morning Report MOD</p>
            <p>Waktu : <?php echo isset($_GET['waktu_mulai']) ? $_GET['waktu_mulai'] : ''; ?> 08.00 - 10.00 <?php echo isset($_GET['waktu_selesai']) ? $_GET['waktu_selesai'] : ''; ?></p>
        </div>

        <div class="row data_absensi_mod">

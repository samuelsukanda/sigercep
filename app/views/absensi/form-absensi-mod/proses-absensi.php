        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    $sql = "SELECT COUNT(*) as count FROM data_absensi_mod WHERE nama='$nama' AND tanggal='$tanggal'";
                    $result = $koneksi->query($sql);
                    $row = $result->fetch_assoc();
                    $count = $row['count'];

                    if ($count == 0) {
                        $sql = "INSERT INTO data_absensi_mod (nama, jabatan, tanggal, tanda_tangan, waktu_input) 
                        VALUES ('$nama', '$jabatan', '$tanggal', '$nama_file_tanda_tangan', '$waktu_input')";

                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            $pjdata = mysqli_real_escape_string($koneksi, $_POST['pjdata']);
                            $numerator = mysqli_real_escape_string($koneksi, $_POST['numerator']);
                            $penumerator = mysqli_real_escape_string($koneksi, $_POST['penumerator']);
                            $capaian = mysqli_real_escape_string($koneksi, $_POST['capaian']);
                            $waktu_input = mysqli_real_escape_string($koneksi, $_POST['waktu_input']);

                            $sql = "INSERT INTO data_pelaporan_indikator_mutu (indikator, periode, unit, pjdata, numerator, penumerator, capaian, waktu_input)
                                VALUES ('$indikator', '$periode', '$unit', '$pjdata', '$numerator', '$penumerator', '$capaian', '$waktu_input')";

...
$query = "SELECT * FROM data_pelaporan_indikator_mutu WHERE id=$id";
...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit Pelaporan Indikator Mutu</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-edit.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="indikator" name="indikator" value="<?php echo $data['indikator']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="periode">Periode:</label>
                                            <input type="text" class="form-control" id="periode" name="periode" value="<?php echo $data['periode']; ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="pjdata">Penanggung Jawab Data:</label>
                                            <input type="text" class="form-control" id="pjdata" name="pjdata" value="<?php echo $data['pjdata']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="numerator">Numerator (N):</label>
                                            <input type="text" class="form-control" id="numerator" name="numerator" value="<?php echo $data['numerator']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="penumerator">Penumerator (D):</label>
                                            <input type="text" class="form-control" id="penumerator" name="penumerator" value="<?php echo $data['penumerator']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="capaian">Capaian (%):</label>
                                            <input type="text" class="form-control" id="capaian" name="capaian" value="<?php echo $data['capaian']; ?>" required>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-komplain-ipsrs.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->
    ...
    <script src="../../../dist/js/validasi-mutu.js"></script>
</body>

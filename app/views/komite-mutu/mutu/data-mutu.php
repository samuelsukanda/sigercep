                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Data Pelaporan Indikator Mutu</h3>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT * FROM data_pelaporan_indikator_mutu";
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    $sql_count = "SELECT COUNT(*) as total FROM data_pelaporan_indikator_mutu";

                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Pelaporan Indikator Mutu</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-mutu.php">

                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="indikator">Judul Indikator:</label>
                                            <input type="text" class="form-control" id="indikator" name="indikator" placeholder="Masukkan Judul Indikator" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="periode">Periode:</label>
                                            <input type="text" class="form-control" id="periode" name="periode" placeholder="(Bulan)" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pjdata" name="pjdata" placeholder="(Jabatan)" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="numerator">Numerator (N):</label>
                                            <input type="text" class="form-control" id="numerator" name="numerator" placeholder="Masukan Numerator" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="penumerator">Penumerator (D):</label>
                                            <input type="text" class="form-control" id="penumerator" name="penumerator" placeholder="Masukan Penumerator" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="capaian">Capaian (%):</label>
                                            <input type="text" class="form-control" id="capaian" name="capaian" placeholder="Masukan Capaian" required>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-mutu.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->

                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Bank SPO Logistik & Pengembangan</h3>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                $query = "SELECT id, file_path FROM data_bank_spo WHERE jenis_spo = 'SPO Terkait' AND logistik_pengembangan = 1";

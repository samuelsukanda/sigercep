                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Bank SPO Akuntansi</h3>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                $query = "SELECT id, file_path FROM data_bank_spo WHERE jenis_spo = 'SPO Utama' AND akuntansi = 1";
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        if (($_SESSION['level'] == 'SUPER ADMIN' && $_SESSION['nama'] == 'IT') ||
                                                            ...
                                                            echo "<td>
                                                            <a href='#' onclick='return confirmDelete($pdfId);' class='btn btn-block btn-danger'>Hapus</a>
                                                            </td>";
                                                }
                                                        echo "</tr>";
                                                    }

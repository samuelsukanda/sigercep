                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Data Manajemen Resiko</h3>
                                </div>
                                        ...
                                        <table id="dataTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Kemungkinan</th>
                                                    <th>Nilai Resiko</th>
                                                    <th>Keterangan Monitoring Risiko</th>
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT * FROM data_manajemen_risiko ORDER BY DATE_FORMAT(tanggal, '%Y-%m-%d') DESC LIMIT $start, $limit";
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    $sql_count = "SELECT COUNT(*) as total FROM data_manajemen_risiko";

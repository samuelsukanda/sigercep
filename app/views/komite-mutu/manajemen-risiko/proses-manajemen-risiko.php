                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            $dampak = mysqli_real_escape_string($koneksi, $_POST['dampak']);
                            $kemungkinan = mysqli_real_escape_string($koneksi, $_POST['kemungkinan']);
                            ...
                            $sql = "INSERT INTO data_manajemen_risiko (nama, tanggal, unit, uraian, dampak, kemungkinan, nilai, keterangan, waktu_input)
                            VALUES ('$nama', '$tanggal', '$unit', '$uraian', '$dampak', '$kemungkinan', '$nilai', '$keterangan', '$waktu_input')";

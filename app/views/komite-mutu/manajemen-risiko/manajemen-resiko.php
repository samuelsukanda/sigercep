...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Manajemen Risiko</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form" method="POST" action="proses-manajemen-risiko.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="uraian">Uraian Risiko:</label>
                                            <input type="text" class="form-control" id="uraian" name="uraian" placeholder="Masukan Uraian Risiko" required onchange="hitungNilaiResiko()">
                                        </div>

                                        <div class="form-group">
                                            <label for="Dampak">Dampak (D):</label>
                                            <select class="form-control" id="dampak" name="dampak" required onchange="hitungNilaiResiko()">
                                                ...
                                                foreach ($options as $option) {
                                                    $selected = ($dampak == $option) ? 'selected' : '';
                                        ...
                                        <div class="form-group">
                                            <label for="Kemungkinan">Kemungkinan (K):</label>
                                            <select class="form-control" id="kemungkinan" name="kemungkinan" required onchange="hitungNilaiResiko()">
                                                <option selected disabled>Pilih Nilai</option>
                                                <?php
                                                ...
                                                foreach ($options as $option) {
                                                    $selected = ($kemungkinan == $option) ? 'selected' : '';
                                                    echo "<option value=\"$option\" $selected>$option</option>";
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="nilai">Nilai Resiko (D x K):</label>
                                            <input type="text" class="form-control" id="nilai" name="nilai" required readonly>
                                        </div>

                                        <div class="form-group">
                                            <label for="keterangan">Keterangan Monitoring Risiko:</label>
                                            <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Masukan Keterangan Monitoring Risiko" required>
                                        </div>
                                        <!-- /.card-body -->
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="data-manajemen-risiko.php" class="btn btn-primary">Tampilkan Data</a>
                                        </div>
                                </form>
                            </div>
                            <!-- /.card -->
    ...
    <script src="../../../dist/js/script-mutu.js"></script>

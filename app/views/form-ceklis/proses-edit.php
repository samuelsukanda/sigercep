                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                foreach ($fields as $field) {
                                    $cek = isset($_POST[$field . '_cek']) ? 1 : 0;
                                    $text = mysqli_real_escape_string($koneksi, $_POST[$field . '_text']);
                                    $sql .= ", {$field}_cek = $cek, {$field}_text = '$text'";
                                }
                                ...
                                if ($result) {
                                    echo "<script>window.location.href = 'data-hardware.php';</script>";
                                } else {

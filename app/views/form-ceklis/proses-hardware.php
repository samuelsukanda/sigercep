                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $fields = [
                                    'wallpaper', 'login', 'password', 'saver', 'vnc', 'folder', 'software',
                                    'hardisk', 'simrs', 'ip', 'ping', 'printer', 'tinta', 'monitor',
                                    'ups', 'mouse', 'keyboard', 'case', 'kabel', 'penempatan'
                                ];

                                $sql_columns = "nama, unit, lantai, tanggal, waktu_input";
                                $sql_values = "'$nama', '$unit', '$lantai', '$tanggal', '$waktu_input'";

                                foreach ($fields as $field) {
                                    $cek = isset($_POST[$field . '_check']) ? 1 : 0;
                                    $text = mysqli_real_escape_string($koneksi, $_POST[$field . '_text']);
                                    $sql_columns .= ", {$field}_cek, {$field}_text";
                                    $sql_values .= ", $cek, '$text'";
                                }

                                $sql = "INSERT INTO data_hardware ($sql_columns) VALUES ($sql_values)";
                                ...
                                if (mysqli_query($koneksi, $sql)) {
                                    ...
                                    echo '<div class="alert alert-danger alert-dismissible">
                                        ...
                                        Error: ' . $sql . "<br>" . mysqli_error($koneksi) . '
                                        </div>';
                                }
